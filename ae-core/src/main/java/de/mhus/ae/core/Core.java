...
import de.mhus.ae.main.MainPanel;
...
import de.mhus.ae.AeApplication;
...
import de.mhus.ae.aaa.SecurityUtils;
import de.mhus.ae.aaa.UsersConfiguration;
import de.mhus.ae.aaa.oauth2.AuthProvider;
import de.mhus.ae.cfg.CfgService;
import de.mhus.ae.config.AbstractUserRelatedConfig;
import de.mhus.ae.config.Configuration;
import de.mhus.ae.config.ViewsConfiguration;
import de.mhus.ae.help.HelpAction;
import de.mhus.ae.help.HelpConfiguration;
import de.mhus.ae.help.LinkHelpAction;
import de.mhus.ae.system.ServerSystemService;
...
public class Core extends AppLayout {
    ...
    private void createHeader(AaaUser user) {
        ...
        if (securityService.hasRole(UsersConfiguration.ROLE.ADMIN.name()) && AeApplication.canRestart()) {
            UiUtil.createIconItem(userMenu, VaadinIcon.WARNING, "Restart Server", null, true).addClickListener(click -> {
                ...
                dialog.addConfirmListener(e -> AeApplication.restart());
                dialog.open();
            });
        }
